<template>
  <div id="app">
    ...
    <el-row id="House" type="flex">
      <el-card :body-style="{ padding: '0px', height: '100%'}" v-for="i in 10" :key="i" class="HouseCard">
        <span class="HouseName">场所{{ i }}</span>
        <img src="../static/images/house1.png" style="height: 100%;" alt="load failed"/>
      </el-card>
    </el-row>
  </div>
</template>
